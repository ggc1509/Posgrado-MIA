...
class Perceptron:
    ...
    def entrenar(self, X, y):
        for epoca in range(self.epocas):
            ...
            print("\n>>> NO CONVERGIÓ: el perceptrón simple no puede resolver XOR <<<")


# Datos de entrenamiento para la compuerta XOR
# Se agrega la tabla de verdad correspondiente a la compuerta XOR
X = np.array([
    [0, 0],
    [0, 1],
    [1, 0],
...
y = np.array([0, 1, 1, 0])  # Salida esperada para XOR
...
for entradas in X:
    ...
    print(f"XOR({entradas[0]}, {entradas[1]}) = {resultado}")
