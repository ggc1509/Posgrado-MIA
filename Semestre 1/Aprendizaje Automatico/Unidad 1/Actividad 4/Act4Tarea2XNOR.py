...
# Código Actividad 2: 
# Implementar un perceptrón para resolver XNOR.
...
class Perceptron:
    ...
    def entrenar(self, X, y):
        for epoca in range(self.epocas):
            ...
            print("\n>>> NO CONVERGIÓ: el perceptrón simple no puede resolver XNOR <<<")


# Datos de entrenamiento para la compuerta XNOR
# Se agrega la tabla de verdad correspondiente a la compuerta XNOR
X = np.array([
    [0, 0],
    [0, 1],
    [1, 0],
...
y = np.array([1, 0, 0, 1])  # Salida esperada para XNOR
...
for entradas in X:
    ...
    print(f"XNOR({entradas[0]}, {entradas[1]}) = {resultado}")
